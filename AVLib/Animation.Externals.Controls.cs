...
namespace AVLib.Animations
{
    ...
    public static class AnimeControlExternals
    {
        ...
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.MouseEnter, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue MouseLeave(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.MouseLeave, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue Click(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.Click, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue MouseDown(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.MouseDonw, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue MouseUp(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.MouseUp, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue DoubleClick(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.DoubleClick, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue DragEnter(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.DragEnter, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue DragLeave(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.DragLeave, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue DragDrop(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.DragDrop, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue Enter(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.Enter, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue Leave(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.Leave, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue GotFocus(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.GotFocus, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue KeyDown(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.KeyDown, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue KeyUp(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.KeyUp, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue LostFocus(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.LostFocus, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue MouseWheel(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.MouseWheel, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue TextChanged(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.TextChanged, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue Visible(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.Visible, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue Enabled(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.Enabled, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }

        public static ControlEventQueue Disabled(this AnimeEventSelector selector)
        {
            return new ControlEventQueue(selector.ctrl, Animations.AnimeEvent.Disabled, -1, null, selector.isQueue) { time = selector.time, SpeedMode = selector.SpeedMode, CompleteIfCancel = selector.CompleteIfCancel };
        }
        ...
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.MouseEnter, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue MouseLeave(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.MouseLeave, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue Click(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.Click, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue MouseDown(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.MouseDonw, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue MouseUp(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.MouseUp, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue DoubleClick(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.DoubleClick, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue DragEnter(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.DragEnter, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue DragLeave(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.DragLeave, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue DragDrop(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.DragDrop, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue Enter(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.Enter, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue Leave(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.Leave, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue GotFocus(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.GotFocus, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue KeyDown(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.KeyDown, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue KeyUp(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.KeyUp, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue LostFocus(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.LostFocus, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue MouseWheel(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.MouseWheel, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue TextChanged(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.TextChanged, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue Visible(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.Visible, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue Enabled(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.Enabled, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }

        public static AnimeCollectorEventQueue Disabled(this AnimeEventCollector collector)
        {
            return new AnimeCollectorEventQueue(collector.collector, Animations.AnimeEvent.Disabled, -1, null, collector.isQueue) { time = collector.time, SpeedMode = collector.SpeedMode, CompleteIfCancel = collector.CompleteIfCancel };
        }
